...
void init() {
    try {
        ...
        /*** multi_sink_logger: print log into stdout and async file ***/
        // auto console_sink = std::make_shared<spdlog::sinks::stdout_color_sink_mt>();
        // auto daily_file_sink = std::make_shared<spdlog::sinks::daily_file_sink_mt>("logs/async_daily_log.txt", 0, 0, false, 3);
